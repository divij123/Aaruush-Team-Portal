...
$query = "select od_details.aid,od_details.reg_no,od_details.date,od_details.hours,od_details.reason,od_details.status_org,od_details.status_pr,od_details.status_con,od_details.committee,od_details.CI_id from od_details INNER JOIN organizer ON organizer.committee=od_details.committee";
